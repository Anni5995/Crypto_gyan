          ...
          children: [
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('0.4' + item.symbol,style: TextStyle(
                      fontSize: 15,
            ...
            Expanded(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('\$ ' + item.currentPrice.toStringAsFixed(2),style: TextStyle(
                      fontSize: 14,
                      fontWeight: FontWeight.bold
                  ),),
                  Row(
                    children: [
                      Text(item.priceChange24H.toString().contains('-')
                      ...
                      Text(item.marketCapChangePercentage24H.toStringAsFixed(2) + '%',style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.normal,
